...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        assertEquals("주문가격 : 가격 * 수량", 10000*orderCount, getOrder.getTotalPrice());
        assertEquals("주문 수량만큼 재고 줄어야 함", 8, book.getStockQuantity());
    }
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals("주문이 취소 된 상품은 재고 원복", 10, item.getStockQuantity());
    }
